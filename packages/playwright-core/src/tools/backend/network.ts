...
import { isJsonMimeType, isTextualMimeType } from '../../utils/isomorphic/mimeType';
...
export async function renderRequest(request: playwright.Request): Promise<string> {
  ...
  // eslint-disable-next-line no-restricted-syntax -- accessing internal _guid for request identification
